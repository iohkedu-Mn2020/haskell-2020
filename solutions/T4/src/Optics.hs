...
{-|
Module      : Optics
Description : optics definitions and combinators
Copyright   : (c) Lars Brünjes, 2020
Maintainer  : lars.bruenjes@iohk.io
Stability   : experimental
Portability : portable

This module contains the basic definitions of
various optics, some example optics various utility functions.
-}
module Optics
